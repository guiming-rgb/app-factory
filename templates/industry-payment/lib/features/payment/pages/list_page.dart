...
class PaymentOrderListPage extends StatefulWidget {
  ...
  @override
  State<PaymentOrderListPage> createState() => _PaymentOrderListPageState();
}

class _PaymentOrderListPageState extends State<PaymentOrderListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("PaymentOrder")),
          ...
          RefreshIndicator(onRefresh: () => _load(), child: ListView.builder(
            itemCount: _items.length, itemBuilder: (_, i) {
              ...
              return Card(child: ListTile(
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentOrderDetailPage(item: item))),
              ));
            }
          )),
        ),
      ]),
      floatingActionButton: FloatingActionButton(onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PaymentOrderFormPage())).then((_) => _load()), child: const Icon(Icons.add)),
    );
  }
}

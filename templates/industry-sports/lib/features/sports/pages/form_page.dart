...
class MatchItemFormPage extends StatefulWidget {
  final Map<String,dynamic>? initial;
  const MatchItemFormPage({super.key, this.initial});
  @override
  State<MatchItemFormPage> createState() => _MatchItemFormPageState();
}

class _MatchItemFormPageState extends State<MatchItemFormPage> {

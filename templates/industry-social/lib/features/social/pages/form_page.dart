...
class _PostFormPageState extends State<PostFormPage> {
  ...
  final _topic_idCtrl = TextEditingController();
  bool _saving = false;
  ...
  void initState() {
    ...
    if (widget.initial != null) {
      ...
      _imagesCtrl.text = (widget.initial!['images'] ?? '').toString();
      _topic_idCtrl.text = (widget.initial!['topic_id'] ?? '').toString();
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      final data = <String, dynamic>{
        ...
        'images': _imagesCtrl.text.trim(),
        'topic_id': _topic_idCtrl.text.trim(),
      };
      ...
      body: Form(
        ...
        child: ListView(padding: const EdgeInsets.all(16), children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(labelText: 'images', border: OutlineInputBorder()),
          ),
          const SizedBox(height: 16),
          TextFormField(
            controller: _topic_idCtrl,
            decoration: const InputDecoration(labelText: 'topic id', border: OutlineInputBorder()),
          ),

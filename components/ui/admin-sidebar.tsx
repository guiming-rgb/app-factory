...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* Mobile toggle */}
      <button
        className="fixed left-4 top-4 z-50 flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-sm lg:hidden"
      ...
      >
        ...
        <div className="flex h-16 items-center border-b border-gray-100 px-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-blue-600 text-sm font-bold text-white">
              A
            </div>
            {!collapsed && (
              <div className="overflow-hidden">
                <p className="text-sm font-bold text-gray-950">App 生产工厂</p>
          ...
          <button
            ...
            className="ml-auto hidden h-8 w-8 items-center justify-center rounded-lg text-gray-400 hover:bg-gray-100 hover:text-gray-600 lg:flex"
        ...
        <div className="border-t border-gray-100 p-4">
          <Link
            href="/"
            className={`flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-700 ${

...
> **日期**：2026-05-20  
> **状态**：**v2b-实现-1/2 已落盘**（模板 + Generator PoC）；Inngest 长任务 **未**实现  
...
| 模板目录 | `templates/flutter-minimal/` | `templates/wechat-miniprogram-minimal/`（✅ 实现-1） |
...
见 [v2b-微信小程序-最小模板-目录结构.md](./v2b-微信小程序-最小模板-目录结构.md) 与 `templates/wechat-miniprogram-minimal/`。
...
**v2b 增强**：Inngest `project/codegen.wechat.requested`、Spec v0.2 正式字段。

...
- [ ] **v4 Auth + RLS**：v4-1～v4-4 ✅ · v4-5～v4-6 待做（[v4-Auth-RLS-设计草案.md](./v4-Auth-RLS-设计草案.md)）
...
5. **v4 Auth + RLS**：v4-1～v4-4 ✅ → 下一步 **v4-5** Inngest userId（[v4-Auth-RLS-设计草案.md](./v4-Auth-RLS-设计草案.md)）

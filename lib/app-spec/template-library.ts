...
export const TEMPLATE_LIBRARY: SpecTemplate[] = [
  ...
  { id: "blog", name: "博客阅读", description: "推荐+分类标签+收藏+历史+作者关注", category: "内容", icon: "📝",
    spec: base("blog","博客",[
      {id:"feed",title:"推荐",type:"list",entity:"article"},{id:"article_detail",title:"阅读",type:"detail",entity:"article"},{id:"category_list",title:"分类",type:"list",entity:"category"},{id:"bookmarks",title:"收藏",type:"list",entity:"article"},{id:"search",title:"搜索",type:"form"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "fitness", name: "健身助手", description: "训练课程+动作库+打卡+身体数据+成就", category: "健康", icon: "💪",
    spec: base("fitness","健身助手",[
      {id:"today",title:"今日",type:"dashboard"},{id:"course_list",title:"课程",type:"list",entity:"course"},{id:"exercise_lib",title:"动作库",type:"list",entity:"exercise"},{id:"workout_log",title:"记录",type:"list",entity:"workout"},{id:"body_stats",title:"身体",type:"list",entity:"body_measure"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "food_delivery", name: "外卖点餐", description: "餐厅搜索+菜单+购物车+优惠券+订单跟踪+评价", category: "电商", icon: "🍕",
    spec: base("food_delivery","外卖",[
      {id:"home",title:"首页",type:"card_grid"},{id:"restaurant_list",title:"商家",type:"list",entity:"restaurant"},{id:"menu",title:"点餐",type:"list",entity:"menu_item"},{id:"cart",title:"购物车",type:"list",entity:"cart_item"},{id:"order_list",title:"订单",type:"list",entity:"order"},{id:"coupon_list",title:"优惠券",type:"list",entity:"coupon"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "property", name: "智慧物业", description: "报修+缴费+访客+公告+设施预约+管家", category: "企业", icon: "🏠",
    spec: base("property","物业",[
      {id:"home",title:"首页",type:"card_grid"},{id:"repair_list",title:"报修",type:"list",entity:"repair"},{id:"payment_list",title:"缴费",type:"list",entity:"payment"},{id:"notice_list",title:"公告",type:"list",entity:"notice"},{id:"visitor_list",title:"访客",type:"list",entity:"visitor"},{id:"facility_book",title:"预约",type:"list",entity:"facility"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "schedule", name: "课程助手", description: "周视图课表+作业+考试+成绩+签到", category: "教育", icon: "📚",
    spec: base("schedule","课程助手",[
      {id:"timetable",title:"课表",type:"calendar"},{id:"course_list",title:"课程",type:"list",entity:"course"},{id:"homework_list",title:"作业",type:"list",entity:"homework"},{id:"exam_list",title:"考试",type:"list",entity:"exam"},{id:"grade_list",title:"成绩",type:"list",entity:"grade"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "entertainment", name: "影音娱乐", description: "分类+推荐+搜索+播放器+收藏+历史", category: "内容", icon: "🎬",
    spec: base("entertainment","影音",[
      {id:"home",title:"首页",type:"card_grid"},{id:"video_list",title:"分类",type:"list",entity:"video"},{id:"video_detail",title:"播放",type:"detail",entity:"video"},{id:"search",title:"搜索",type:"form"},{id:"favorites",title:"收藏",type:"list",entity:"video"},{id:"history",title:"历史",type:"list",entity:"video"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "finance_tracker", name: "记账理财", description: "收支记录+多账户+预算+报表+提醒", category: "金融", icon: "💰",
    spec: base("finance_tracker","记账本",[
      {id:"home",title:"总览",type:"dashboard"},{id:"transaction_list",title:"账单",type:"list",entity:"transaction"},{id:"add_transaction",title:"记一笔",type:"form",entity:"transaction"},{id:"account_list",title:"账户",type:"list",entity:"account"},{id:"budget_list",title:"预算",type:"list",entity:"budget"},{id:"report",title:"报表",type:"chart"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "sports", name: "体育赛事", description: "实时比分+赛程+积分榜+球队数据+新闻+关注", category: "内容", icon: "⚽",
    spec: base("sports","体育",[
      {id:"live",title:"直播",type:"card_grid"},{id:"match_list",title:"赛程",type:"list",entity:"match"},{id:"match_detail",title:"详情",type:"detail",entity:"match"},{id:"standings",title:"积分榜",type:"list",entity:"standing"},{id:"team_list",title:"球队",type:"list",entity:"team"},{id:"news_list",title:"资讯",type:"list",entity:"news"},{id:"profile",title:"我的",type:"placeholder"}
    ], [
  ...
  { id: "dating", name: "交友匹配", description: "滑动匹配+资料完善+筛选+喜欢+聊天+会员", category: "社交", icon: "💕",
    spec: base("dating","交友",[
      {id:"discover",title:"发现",type:"card_grid"},{id:"profile_detail",title:"资料",type:"detail",entity:"user_profile"},{id:"edit_profile",title:"编辑资料",type:"form",entity:"user_profile"},{id:"matches",title:"匹配",type:"list",entity:"match"},{id:"chat",title:"聊天",type:"chat"},{id:"my_profile",title:"我的",type:"placeholder"}
    ], [

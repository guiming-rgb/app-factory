...
- **跨会话接力（TCM）**： [docs/ONE_PAGER.md](./docs/ONE_PAGER.md)（一页简报）· [docs/CONTINUOUS_DELIVERY_OUTLINE.md](./docs/CONTINUOUS_DELIVERY_OUTLINE.md) · [docs/HANDOFF.md](./docs/HANDOFF.md) · [docs/SESSION_START_TEMPLATE.md](./docs/SESSION_START_TEMPLATE.md) · [docs/验收记录.md](./docs/验收记录.md)（**验收 A**） · `.cursor/rules/tcm-continuity.mdc`
